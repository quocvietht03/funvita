...
$fullwidth = isset($funvita_options['portfolio_fullwidth'])&&$funvita_options['portfolio_fullwidth'] ? 'fullwidth': 'container';
$columns = (int) isset($funvita_options['portfolio_columns']) ?  $funvita_options['portfolio_columns']: 1;
$sidebar_width = (int) isset($funvita_options['portfolio_sidebar_width']) ?  $funvita_options['portfolio_sidebar_width']: 3;
...
$portfolio_titlebar = isset($funvita_options['portfolio_titlebar']) ? $funvita_options['portfolio_titlebar']: true;
if($portfolio_titlebar) funvita_titlebar();
?>
