...
$fullwidth = isset($funvita_options['product_fullwidth'])&&$funvita_options['product_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($funvita_options['product_sidebar_width']) ?  $funvita_options['product_sidebar_width']: 3;
