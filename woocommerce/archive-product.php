...
$fullwidth = isset($funvita_options['shop_fullwidth'])&&$funvita_options['shop_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($funvita_options['shop_sidebar_width']) ? $funvita_options['shop_sidebar_width']: 3;
$sidebar_width_md = $sidebar_width + 1;

$shop_top_bar = isset($funvita_options['shop_top_bar']) ? $funvita_options['shop_top_bar']: false;
$shop_product_per_row = (int) isset($funvita_options['shop_product_per_row']) ? $funvita_options['shop_product_per_row']: 3;
