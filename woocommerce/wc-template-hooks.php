...
add_filter( 'loop_shop_per_page', 'funvita_loop_shop_per_page', 20 );
function funvita_loop_shop_per_page( $cols ) {
	global $funvita_options;
	$cols = (int) isset($funvita_options['shop_product_per_page']) ? $funvita_options['shop_product_per_page']: 10;
	return $cols;
}
