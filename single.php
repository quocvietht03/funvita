...
$fullwidth = isset($funvita_options['post_fullwidth'])&&$funvita_options['post_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($funvita_options['post_sidebar_width']) ?  $funvita_options['post_sidebar_width']: 3;
$sidebar_width_md = $sidebar_width + 1;
$post_navigation = isset($funvita_options['single_post_navigation']) ? $funvita_options['single_post_navigation']: true;
$author = isset($funvita_options['single_author']) ? $funvita_options['single_author']: true;
$comment = isset($funvita_options['single_comment']) ? $funvita_options['single_comment']: true;
...
$post_titlebar = isset($funvita_options['post_titlebar']) ? $funvita_options['post_titlebar']: true;
if($post_titlebar) funvita_titlebar();
			...
			<div class="row">
				...
				<div class="bt-content <?php echo esc_attr($content_class); ?>">
					...
					while ( have_posts() ) : the_post();
						...
						if($post_navigation) funvita_post_nav();
						
						$author_desc = get_the_author_meta('description');
						if($author && $author_desc) echo funvita_author_render();
