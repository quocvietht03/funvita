...
$fullwidth = isset($funvita_options['single_portolio_fullwidth'])&&$funvita_options['single_portolio_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($funvita_options['single_portolio_sidebar_width']) ?  $funvita_options['single_portolio_sidebar_width']: 3;
$sidebar_width_md = $sidebar_width + 1;
$related_post = isset($funvita_options['single_portfolio_related_post']) ? $funvita_options['single_portfolio_related_post']: true;
$related_post_label = isset($funvita_options['single_portfolio_related_post_label'])&&$funvita_options['single_portfolio_related_post_label'] ? $funvita_options['single_portfolio_related_post_label']: esc_html__('Portfolio Related', 'funvita');
$related_post_count = (int) isset($funvita_options['single_portfolio_related_post_count'])&&$funvita_options['single_portfolio_related_post_count'] ? $funvita_options['single_portfolio_related_post_count']: 3;
$related_post_per_row = (int) isset($funvita_options['single_portfolio_related_post_per_row'])&&$funvita_options['single_portfolio_related_post_per_row'] ? $funvita_options['single_portfolio_related_post_per_row']: 3;
...
$single_portfolio_titlebar = isset($funvita_options['single_portfolio_titlebar']) ? $funvita_options['single_portfolio_titlebar']: true;
if($single_portfolio_titlebar) funvita_titlebar();
?>
