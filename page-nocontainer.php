...
$page_comment = (int) isset($funvita_options['page_comment']) ?  $funvita_options['page_comment']: 1;
$sidebar_width = (int) isset($funvita_options['sidebar_width']) ?  $funvita_options['sidebar_width']: 3;
