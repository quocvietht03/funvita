...
$fullwidth = isset($funvita_options['services_fullwidth'])&&$funvita_options['services_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($funvita_options['services_sidebar_width']) ?  $funvita_options['services_sidebar_width']: 3;
...
$services_titlebar = isset($funvita_options['services_titlebar']) ? $funvita_options['services_titlebar']: true;
if($services_titlebar) funvita_titlebar();
?>
