...
$manifest['id']                  = 'funvita';
$manifest['skin']                = 'main';
$manifest['name']                = esc_html__( 'Bearsthemes', 'funvita' );
$manifest['uri']                 = 'http://bearsthemespremium.com/theme/funvita/';
$manifest['description']         = esc_html__( 'WordPress Theme', 'funvita' );
