...
$options = array(
	'menu_item_padding' => array(
		'label' => esc_html__('Menu Item Padding', 'funvita'),
		'desc' => esc_html__('Please enter number with px or % for menu item level 1 padding (default: 0px 10px)', 'funvita'),
		'type' => 'short-text',
		'value' => '0px 15px'
	),
	'sub_menu_padding' => array(
		'label' => esc_html__('Sub Menu Padding', 'funvita'),
		'desc' => esc_html__('Please enter number with px or % for sub menu padding (default: 0px)', 'funvita'),
		'type' => 'short-text',
		'value' => '0px'
	),
	'sub_menu_align' => array(
		...
		'choices' => array(
			'menu-align-left' => esc_html__('Left', 'funvita'),
			'menu-align-right' => esc_html__('Right', 'funvita'),
		),
		'inline' => true,
	),
	'badge' => array(
