...
$fullwidth = isset($funvita_options['single_store_picture_fullwidth'])&&$funvita_options['single_store_picture_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($funvita_options['single_store_picture_sidebar_width']) ?  $funvita_options['single_store_picture_sidebar_width']: 3;
...
$single_store_picture_titlebar = isset($funvita_options['single_store_picture_titlebar']) ? $funvita_options['single_store_picture_titlebar']: true;
if($single_store_picture_titlebar) funvita_titlebar();
?>
