...
$fullwidth = isset($funvita_options['single_team_fullwidth'])&&$funvita_options['single_team_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($funvita_options['single_team_sidebar_width']) ?  $funvita_options['single_team_sidebar_width']: 3;
...
$single_team_titlebar = isset($funvita_options['single_team_titlebar']) ? $funvita_options['single_team_titlebar']: true;
if($single_team_titlebar) funvita_titlebar();
?>
