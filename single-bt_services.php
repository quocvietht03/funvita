...
$fullwidth = isset($funvita_options['single_services_fullwidth'])&&$funvita_options['single_services_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($funvita_options['single_services_sidebar_width']) ?  $funvita_options['single_services_sidebar_width']: 3;
...
$single_services_titlebar = isset($funvita_options['single_services_titlebar']) ? $funvita_options['single_services_titlebar']: true;
if($single_services_titlebar) funvita_titlebar();
?>
