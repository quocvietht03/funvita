<?php
class funvita_Post_List_Widget extends funvita_Widget {
	function __construct() {
		parent::__construct(
			'funvita_post_list', // Base ID
			esc_html__('Post List', 'funvita'), // Name
		...
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => esc_html__( 'Post List', 'funvita' ),
...
/* Class funvita_Post_List_Widget */
function funvita_post_list_widget() {
    register_widget('funvita_Post_List_Widget');
}

add_action('widgets_init', 'funvita_post_list_widget');
