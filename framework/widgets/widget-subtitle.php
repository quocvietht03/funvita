<?php
if ( ! class_exists( 'Funvita_Widget_Subtitle' ) ) :

class Funvita_Widget_Subtitle {
	...
	function in_widget_form( $widget, $return, $instance ) {
		...
		<p>
			<label><?php esc_html_e( 'Subtitle:', 'funvita' ); ?></label>
...
$widget_subtitle = new Funvita_Widget_Subtitle();
