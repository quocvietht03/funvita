<?php
class funvita_Mini_Account_Widget extends WP_Widget {
    function __construct() {
        parent::__construct(
                'mini_account_widget', // Base ID
                esc_html__('Mini Account', 'funvita'), // Name
                array('description' => esc_html__('Mini Account Widget', 'funvita'),) // Args
        );
    }
    ...
    function form($instance) {
		...
		?>
		<p>
			<label for="<?php echo esc_url($this->get_field_id('login_text')); ?>"><?php _e('Login Text:', 'funvita');
		 ?></label>
		...
		<p>
			<label for="<?php echo esc_url($this->get_field_id('logout_text')); ?>"><?php _e('Logout Text:', 'funvita');
		 ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('cl_class')); ?>"><?php _e('Extra Class:', 'funvita'); ?></label>
...
/**
 * Class funvita_Mini_Acount_Widget
 */
function funvita_register_mini_account_widget() {
    register_widget('funvita_Mini_Account_Widget');
}
add_action('widgets_init', 'funvita_register_mini_account_widget');
?>
