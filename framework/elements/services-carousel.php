...
class WPBakeryShortCode_bt_services_carousel extends WPBakeryShortCode {
	...
	protected function content( $atts, $content = null ) {
		...
		wp_add_inline_script( 'funvita-main', $data_script );
...
vc_map(array(
	'name' => esc_html__('Services Carousel', 'funvita'),
    ...
    'params' => array(
		...
		array (
			...
			'description' => esc_html__('Note: By default, all your projects will be displayed. If you want to narrow output, select category(s) above. Only selected categories will be displayed.', 'funvita')
		),
		array(
			'type' => 'textfield',
		...
		array(
			...
			'value' => array(
				...
				esc_html__('Layout Icon 1', 'funvita') => 'layout1',
				esc_html__('Layout Image 1', 'funvita') => 'layout-img1',
				esc_html__('Layout Image 2', 'funvita') => 'layout-img2',
				esc_html__('Layout Image 3', 'funvita') => 'layout-img3',
				esc_html__('Layout Image 4', 'funvita') => 'layout-img4',
				esc_html__('Layout Image 5', 'funvita') => 'layout-img5'
			),
			'admin_label' => true,
