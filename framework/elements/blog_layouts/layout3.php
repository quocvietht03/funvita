...
<div class="bt-item">
	...
	<div class="bt-content">
		<ul class="bt-meta">
			...
			<li><?php echo esc_html__('by ', 'funvita'); ?><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><?php echo get_the_author(); ?></a></li>
			<?php if(comments_open()){ ?>
				<li><a href="<?php comments_link(); ?>"><?php comments_number( esc_html__('0 Comments', 'funvita'), esc_html__('1 Comment', 'funvita'), esc_html__('% Comments', 'funvita') ); ?></a></li>
			<?php } ?>
		</ul>
		...
		<?php
			...
			echo funvita_tooltip_share_render();
		?>
	</div>
</div>
