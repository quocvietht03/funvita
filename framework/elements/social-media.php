...
vc_map(array(
	'name' => esc_html__('Social Media', 'funvita'),
	...
	'params' => array(
		...
		array(
			...
			'description' => esc_html__('Please, select logo for option - social_media.', 'funvita'),
			'params' => array(
				array(
					'type' => 'textfield',
					'class' => '',
					'heading' => esc_html__('Icon', 'funvita'),
					'param_name' => 'icon',
				...
				array(
					...
					'param_name' => 'link',
					'description' => esc_html__('Add link of social in this element.', 'funvita')
				),
			)
		),
		array(
