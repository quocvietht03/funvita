...
vc_map(array(
	'name' => esc_html__('Fancy Box', 'funvita'),
	'base' => 'bt_fancy_box',
	...
	'params' => array(
		array(
			...
			'param_name' => 'style',
			'value' => array(
				esc_html__('Icon Top', 'funvita') => 'icon-top',
				esc_html__('Icon Left', 'funvita') => 'icon-left',
				esc_html__('Icon Right', 'funvita') => 'icon-right'
			),
		...
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Content Space', 'funvita'),
			...
			'description' => esc_html__('Please, enter number with px space between content and icon in this element. Ex: 60px', 'funvita')
		),
		...
		array(
			'type' => 'dropdown',
			'heading' => esc_html__('Icon Style', 'funvita'),
			'param_name' => 'icon_style',
			'value' => array(
				esc_html__('None', 'funvita') => '',
				esc_html__('Square', 'funvita') => 'square',
				esc_html__('Rounded', 'funvita') => 'rounded',
				esc_html__('Circle', 'funvita') => 'circle'
			),
			'group' => esc_html__('Icon', 'funvita'),
			'description' => esc_html__('Select style icon in this elment.', 'funvita')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Icon Size', 'funvita'),
			...
			'description' => esc_html__('Please, enter number size icon in this element. Ex: 60px', 'funvita')
		),
		array(
			'type' => 'textfield',
		...
		array(
			...
			'description' => esc_html__('Select border style icon in this elment.', 'funvita')
		),
		array(
			'type' => 'textfield',
			...
			'description' => esc_html__('Please, enter number with px border width icon in this element. Ex: 2px', 'funvita')
		),
		array(
			'type' => 'colorpicker',
			...
			'description' => esc_html__('Select border color icon in this element.', 'funvita')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Space', 'funvita'),
			'param_name' => 'icon_space',
			'value' => '',
			'group' => esc_html__('Icon', 'funvita'),
			'description' => esc_html__('Please, enter number with px space between icon and content in this element. Ex: 30px', 'funvita')
		),
		array(
			'type' => 'textfield',
		...
		array(
			...
			'group' => esc_html__('Title', 'funvita'),
			'description' => esc_html__('Add custom link of the title in this element.', 'funvita')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Font Size', 'funvita'),
		...
		array(
			...
			'value' => '',
			'group' => esc_html__('Title', 'funvita'),
			'description' => esc_html__('Please, enter number with px space between title and description in this element. Ex: 15px', 'funvita')
		),
		array(
			'type' => 'textarea_html',
			'heading' => esc_html__('Description', 'funvita'),
			'param_name' => 'content',
			'value' => '',
			'group' => esc_html__('Description', 'funvita'),
			'description' => esc_html__('Please, enter description in this element.', 'funvita')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Font Size', 'funvita'),
			...
			'value' => '',
			'group' => esc_html__('Description', 'funvita'),
			'description' => esc_html__('Please, enter number  with px font size description in this element. Ex: 14px', 'funvita')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Line Height', 'funvita'),
			...
			'value' => '',
			'group' => esc_html__('Description', 'funvita'),
			'description' => esc_html__('Please, enter number with px line height description in this element. Ex: 24px', 'funvita')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Letter Spacing', 'funvita'),
			...
			'value' => '',
			'group' => esc_html__('Description', 'funvita'),
			'description' => esc_html__('Please, enter number with px letter spacing description in this element. Ex: 1px', 'funvita')
		),
		array(
			'type' => 'colorpicker',
			'heading' => esc_html__('Color', 'funvita'),
			...
			'value' => '',
			'group' => esc_html__('Description', 'funvita'),
			'description' => esc_html__('Select color description in this element.', 'funvita')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Space', 'funvita'),
			...
			'value' => '',
			'group' => esc_html__('Description', 'funvita'),
			'description' => esc_html__('Please, enter number with px space between description and read more in this element. Ex: 15px', 'funvita')
		),
		array(
			'type' => 'vc_link',
			'heading' => esc_html__('URL (Link)', 'funvita'),
			'param_name' => 'link',
			'group' => esc_html__('Extra Link', 'funvita'),
			'description' => esc_html__('Add extra link in this element.', 'funvita')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Font Size', 'funvita'),
			...
			'value' => '',
			'group' => esc_html__('Extra Link', 'funvita'),
			'description' => esc_html__('Please, enter number  with px font size extra link in this element. Ex: 14px', 'funvita')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Line Height', 'funvita'),
			...
			'value' => '',
			'group' => esc_html__('Extra Link', 'funvita'),
			'description' => esc_html__('Please, enter number with px line height extra link in this element. Ex: 24px', 'funvita')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Letter Spacing', 'funvita'),
			...
			'value' => '',
			'group' => esc_html__('Extra Link', 'funvita'),
			'description' => esc_html__('Please, enter number with px letter spacing extra link in this element. Ex: 1px', 'funvita')
		),
		array(
			'type' => 'colorpicker',
			'heading' => esc_html__('Color', 'funvita'),
			...
			'value' => '',
			'group' => esc_html__('Extra Link', 'funvita'),
			'description' => esc_html__('Select color extra link in this element.', 'funvita')
		),
		array(
			'type' => 'css_editor',
