	...
	protected function content( $atts, $content = null ) {
		...
		?>
			<div class="<?php echo esc_attr(implode(' ', $css_class)); ?>"  <?php echo esc_attr(implode(' ', $wrapper_attributes)); ?>>
				<?php funvita_page_breadcrumb($home_text, $delimiter); ?>
			</div>
		<?php
		return ob_get_clean();
	}
...
vc_map(array(
	'name' => esc_html__('Page Breadcrumb', 'funvita'),
	...
	'params' => array(
		array(
			...
			'description' => esc_html__('Select text align in this elment.', 'funvita')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Home Text', 'funvita'),
			'param_name' => 'home_text',
			'value' => 'Home',
			'description' => esc_html__('Please, enter home text in this element.', 'funvita')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Delimiter', 'funvita'),
			'param_name' => 'delimiter',
			'value' => '-',
			'description' => esc_html__('Please, enter delimiter in this element.', 'funvita')
		),
