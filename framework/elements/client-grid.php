...
vc_map(array(
	'name' => esc_html__('Client Logo Grid', 'funvita'),
	'base' => 'bt_client_grid',
	...
	'params' => array(
		array(
			...
			'param_name' => 'columns',
			'value' => array(
				esc_html__('6 Items', 'funvita') => 'col-6',
				esc_html__('5 Items', 'funvita') => 'col-5',
				esc_html__('4 Items', 'funvita') => 'col-4',
				esc_html__('3 Items', 'funvita') => 'col-3',
				esc_html__('2 Items', 'funvita') => 'col-2',
				esc_html__('1 Item', 'funvita') => 'col-1'
			),
