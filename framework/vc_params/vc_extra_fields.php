 ...
 */
function funvita_taxonomy_settings_field($settings, $value) {
...
funvita_add_extra_parame('bt_taxonomy', 'funvita_taxonomy_settings_field', get_template_directory_uri().'/assets/vc_extend/taxonomy.js');

/*
 * Layout select list field
 */
function funvita_layout_settings_field($settings, $value) {
    $dependency = function_exists('vc_generate_dependencies_attributes') ? vc_generate_dependencies_attributes($settings) : '';
...
funvita_add_extra_parame('bt_layout', 'funvita_layout_settings_field', get_template_directory_uri().'/assets/vc_extend/layout.js');
