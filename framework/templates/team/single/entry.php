...
$post_title = isset($funvita_options['single_team_title']) ? $funvita_options['single_team_title']: false;
...
if(!empty($social)){
	foreach($social as $item){
		$social_item[] = '<li><a href="'.esc_url($item['link']).'" data-icon="'.esc_attr($item['icon']).'"><i class="'.esc_attr($item['icon']).'"></i></a></li>';
	}
}
?>
<article <?php post_class(); ?>>
	<div class="row">
		...
		<div class="col-md-5 col-md-offset-1">
			...
			<div class="bt-info">
				<h4><?php esc_html_e('Information', 'funvita'); ?></h4>
				<ul>
			...
			<div class="bt-social">
				<h4><?php esc_html_e('Social', 'funvita'); ?></h4>
