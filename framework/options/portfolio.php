...
Redux::setSection( $opt_name, array(
	'title'            => esc_html__( 'Portfolio', 'funvita' ),
	'id'               => 'bt_portfolio',
	...
	'fields'           => array(
		...
		array(
			...
			'desc'  => esc_html__( 'This is the options you can change the post on the portfolio page.', 'funvita' )
		),
		array(
			'id'       => 'portfolio_title',
			'type'     => 'switch',
...
Redux::setSection( $opt_name, array(
	'title'            => esc_html__( 'Single Portfolio', 'funvita' ),
	...
	'fields'           => array(
		...
		array(
			...
			'type'     => 'switch',
			'title'    => esc_html__( 'Related Post', 'funvita' ),
			'subtitle' => esc_html__( 'Turn on to show the related post.', 'funvita' ),
			'default'  => true
		),
		array(
		...
		array(
			...
			'type'     => 'text',
			'title'    => esc_html__( 'Related Post Count', 'funvita' ),
			'subtitle' => esc_html__( 'Please, Enter post count of the related post. Leave empty to use "3" for post count.', 'funvita' ),
			'default'  => '3',
			'required' 		=> array('single_portfolio_related_post' , '=', '1'),
		),
		array(
			...
			'type'          => 'slider',
			'title'         => esc_html__( 'Related Post Per Row', 'funvita' ),
			'subtitle'      => esc_html__( 'Controls the post per row of the related post.', 'funvita' ),
			'default'       => 3,
			'min'           => 1,
			'step'          => 1,
			'max'           => 4,
		...
		array(
			...
			'right'   => false,
			'left'   => false,
			'title'    => esc_html__( 'Related Post Space', 'funvita' ),
			'subtitle' => esc_html__( 'Control the bottom margin the related post.', 'funvita' ),
			'default'  => array(
				'margin-bottom' => '30px'
			),
